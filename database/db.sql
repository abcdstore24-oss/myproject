...
-- =====================================================
-- EVENT SCHEDULER (Disabled for Aiven — use a cron job in your backend instead)
-- =====================================================
-- NOTE: Aiven does not support SET GLOBAL or custom EVENTs via import.
-- To auto-update test status, add a cron job in your Express backend using node-cron.
